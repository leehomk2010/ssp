...
public class BaseController {
    ...
    public String getUrlPrefix(){
        return getRequest().getSession().getServletContext().getAttribute("urlPrefix").toString();
    }

    public String getRealPath(){
        return getRequest().getSession().getServletContext().getAttribute("realPath").toString();
    }
